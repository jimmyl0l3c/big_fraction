import 'package:fraction/big_fraction.dart';
import 'package:fraction_example/src/analyzer/analyzer.dart';

/// Tries to convert a [String] into a [MixedFraction]
class MixedFractionAnalyzer extends RationalAnalyzer {
